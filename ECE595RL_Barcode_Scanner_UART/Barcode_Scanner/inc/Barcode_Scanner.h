...
/**
 * @brief Initializes the Barcode Scanner module for UART communication.
 *
 * @param None
 *
 * @return None
...
/**
 * @brief Reads a single character from the Barcode Scanner module.
 * This function waits until a character is available in the receive buffer before reading it.
 *
 * @param None
 *
 * @return The character read from the Barcode Scanner module.
 */
uint8_t Barcode_Scanner_InChar();

/**
 * @brief Sends a single character to the Barcode Scanner module for transmission.
 * This function waits until the transmit buffer is ready to accept a new character before sending it.
 *
 * @param data The character to be sent to the Barcode Scanner module.
 *
 * @return None
 */
